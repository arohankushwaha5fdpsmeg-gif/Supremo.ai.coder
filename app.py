...
# CORE API ENVIRONMENT KEYS DECLARATION
SECRET_KEY = os.environ.get('2468642', secrets.token_hex(16))
STRIPE_SECRET_KEY = os.environ.get("sk_test_51Tke3WRsVgVw9kTXB7nWOrvb1jGUnCuTAqwgcX5OA7r7hxVh534pcyg5Y0D989GwT4CQmwsfN9SezJyb8gEdjXDF00OEi2JoDS", "sk_test_placeholder")
